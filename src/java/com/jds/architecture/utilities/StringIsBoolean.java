 ...
 * translates to a boolean value using JDS architecture standards {"TRUE",
 * "YES", "OK"}. The method uses the argument object's toString() method to
...
public class StringIsBoolean implements ValidationStrategy {
	...
	public boolean validate(Object target) {
		...
		String tmp = ((String) target).toLowerCase(); // TRUE==true
		System.out.println(target);
		if (tmp.equals("true") || tmp.equals("ok") || tmp.equals("yes"))
			return true;
