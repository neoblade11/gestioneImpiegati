 ...
 * to an long a value.  The method uses the argument object's toString() method to 
 * obtain its string representation and the <code>Long.parseLong(String)</code> method
 * for parsing.
 * 
