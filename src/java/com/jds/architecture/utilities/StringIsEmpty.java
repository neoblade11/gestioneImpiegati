...
/**
 * Validation strategy object used to determine if the argument object's string
 * representation compares to an empty string "" according to the
 * <code>String.equals()</code>.
 * 
 * The inherited method <code>validate(Object target)</code> accepts any object
 * to be validated. RuntimeExceptions will be thrown when any other argument is
...
public class StringIsEmpty implements ValidationStrategy {
	...
	/**
	 * Determines if the string representaiton of the argument object compares to an
	 * empty string "".
	 * 
	 * @param target the object whose string representation is to be validated
	 * @return boolean true if the argument's string representation is equivalent to
	 *         "" according to the String.equals(String) method, false otherwise.
	 */
