 ...
 * to an integer a value.  The method uses the argument object's toString() method to 
 * obtain its string representation and the <code>Integer.parseInteger(String)</code> method
 * for parsing.
 * 
