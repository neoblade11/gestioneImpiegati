...
<html:form action="/categorysave" focus="category" method="POST">
  ...
  <tr> 
    <td colspan="2" valign="top"> 
	  ...
	  <tr>
	    ...
	    <font size="4" color="#FFFFFF"><b>Add Category</b></font></td>
	  </tr>
	  ...
	  <tr>
 	  ...
 	  <tr>
 	  	<td width="50%" align="right"><br><html:submit value="Save"/></td>
