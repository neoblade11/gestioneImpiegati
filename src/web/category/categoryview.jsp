  ...
  <tr> 
    <td colspan="2" valign="top"> 
	  ...
	  <tr>
	    ...
	    <font face="Arial, Helvetica, sans-serif" size="4" color="#FFFFFF"><b>Category Information</b></font></td>
	  </tr>
	  <tr>
	    <td align="left">
			...
			<tr>
	            ...
	            <td width="50%" style="border-style: none; border-width: medium" valign="bottom"><bean:write name="CategoryForm" property="category"/></td>
          	</tr>
          	<tr>
	            ...
	            <td width="50%" style="border-style: none; border-width: medium"><bean:write name="CategoryForm" property="description"/></td>
          	</tr>
			</table>
	  	</td>	
	  </tr>
	  </tr>
	  	<tr><td colspan="3" align="center"><br><input type="button" value="Close" name="B1" onClick="javascript:history.back()"></td>
	  </tr>	  
</table>
</body>
</form>
