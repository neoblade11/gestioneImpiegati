  ...
  <tr> 
    <td colspan="2" valign="top"> 
	  ...
	  <tr>
	    ...
	    <font face="Arial, Helvetica, sans-serif" size="4" color="#FFFFFF"><b>Project Information</b></font></td>
	  </tr>
	  <tr>
	    <td align="left">
			...
			<tr>
	            ...
	            <td width="50%" style="border-style: none; border-width: medium" valign="bottom">
	            <bean:write name="ProjectForm" property="project"/></td>
          	</tr>
			<tr>
	            ...
	            <td width="50%" style="border-style: none; border-width: medium" valign="bottom">
	            <bean:write name="ProjectForm" property="startDate"/></td>
          	</tr>
			<tr>
	            <td width="17%" style="border-style: none; border-width: medium">&nbsp;</td>
	            <td width="17%" style="border-style: none; border-width: medium" colspan="2"></td>
	            ...
	            <td width="50%" style="border-style: none; border-width: medium" valign="bottom">
	            <bean:write name="ProjectForm" property="endDate"/></td>
          	</tr>
			<tr>
	            <td width="17%" style="border-style: none; border-width: medium">&nbsp;</td>
	            <td width="17%" style="border-style: none; border-width: medium" colspan="2"></td>
	            <td width="16%" style="border-style: none; border-width: medium" valign="bottom"><b>Client</b></td>
	            <td width="50%" style="border-style: none; border-width: medium" valign="bottom">
	            <bean:write name="ProjectForm" property="client"/></td>
          	</tr>
          	<tr>
	            <td width="17%" style="border-style: none; border-width: medium"></td>
	            <td width="17%" style="border-style: none; border-width: medium" colspan="2"></td>
	            <td width="16%" style="border-style: none; border-width: medium"><b>Description</b></td>
	            <td width="50%" style="border-style: none; border-width: medium"><bean:write name="ProjectForm" property="description"/></td>
          	</tr>
			</table>
	  	</td>	
	  </tr>
